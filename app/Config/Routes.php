...
$routes->group('api/v1', ['namespace' => 'App\Controllers\Api\V1'], static function ($routes) {
    ...
    $routes->group('auth', ['namespace' => 'App\Controllers\Api\V1', 'filter' => 'noauth'], static function ($routes) {
        $routes->post('login', 'AuthController::login');          // POST
    });


    $routes->group('', ['namespace' => 'App\Controllers\Api\V1', 'filter' => 'auth'], static function ($routes) {
